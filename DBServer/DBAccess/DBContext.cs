    ...
    public class DBContext
    {
        ...
        public UserInfo GetUserInfo(string username)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    userInfo = new UserInfo(reader.IsDBNull(0) ? "Unknown" : reader.GetString(0),
                        reader.IsDBNull(1) ? "Unknown" : reader.GetString(1),
        ...
        {
            string sql = "Update moviedb.[dbo].[Users] set [passwordHash] = '" + user.hash + "' where username = '" +
                         user.username + "'";
            try
            {
        ...
        public string GetDirectorRating(string directorId)
        {
            string rating = "";
            string sql =
                "SELECT AVG(m.rating) FROM [dbo].[movieInfo] m where DirectorID = " + directorId;
            try
            {
        ...
        public List<string> GetStarsInMovie(int movieId)
        {
            ...
            string sql = "Select [StarID] from moviedb.dbo.starInfo where movieID = " + movieId;
            try
            {
